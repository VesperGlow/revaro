...
@media(max-width:850px){.topbar{padding-right:max(14px,env(safe-area-inset-right,0px));padding-left:max(14px,env(safe-area-inset-left,0px))}.brand-button{flex:0 0 auto;white-space:nowrap}.top-actions{flex:0 0 auto;gap:6px}.account-copy{display:none}.account-button{flex:0 0 auto}.mobile-tool-menu{flex:0 0 auto}}
...
@media(max-width:350px){.topbar{padding-right:max(8px,env(safe-area-inset-right,0px));padding-left:max(8px,env(safe-area-inset-left,0px))}.brand-button{padding-right:2px;padding-left:2px}.top-actions{gap:2px}}
