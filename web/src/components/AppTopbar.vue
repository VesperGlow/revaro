...
@media(max-width:850px){.topbar{padding-right:max(14px,env(safe-area-inset-right,0px));padding-left:max(14px,env(safe-area-inset-left,0px))}.brand-logo{height:24px}.brand-button{flex:0 0 auto;white-space:nowrap}.top-actions{flex:0 0 auto;gap:5px}.account-copy{display:none}.account-button{flex:0 0 auto}.top-actions :deep(.system-status>summary){width:38px;height:40px}.mobile-tool-menu{flex:0 0 auto}}
