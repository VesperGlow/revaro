...
export interface VideoFMP4Fragment { number:number;start:number;duration:number;url:string;init_url:string;window_start:number;window_end:number;timestamp_offset:number;timing_approximate:boolean }
