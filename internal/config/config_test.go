...
func TestLoadDefaults(t *testing.T) {
	...
	if c.BlockRAMCacheCapacity != 256<<20 || c.BlockSSDCacheCapacity != 8<<30 || c.BlockCacheMinFree != 2<<30 || c.BlockReadAhead != 64<<20 || c.BlockCacheDir != filepath.Join(c.DataDir, "block-cache") {
